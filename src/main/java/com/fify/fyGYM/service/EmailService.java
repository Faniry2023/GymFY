...
public class EmailService {
    ...
    // ── Gardez vos méthodes HTML exactement comme avant ──
    private String construireHtmlFacture(String prenomNom, Long numeroFacture,
                                         List<PanierItem> produits, long total, String codeLivraison) {
        // ... votre code HTML existant, ne changez rien ici
    ...
    private String construireHtmlVerification(String prenom, String code) {
        // ... votre code HTML existant, ne changez rien ici
        return ""; // remplacez par votre vrai code
    }
}
